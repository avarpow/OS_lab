...
void MemoryManager::initialize()
{
    ...
    int userPhysicalBitMapStart = kernelPhysicalBitMapStart + ceil(next_power_of_two(kernelPages)*2, 8);
    int kernelVirtualBitMapStart = userPhysicalBitMapStart + ceil(next_power_of_two(userPages)*2, 8);
